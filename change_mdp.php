...
$sql_E='select mdp from expediteur where email="'.$email_r.'"';
//Exécution
...
while($part_T=mysqli_fetch_array($query_T)){
 ...
 echo'<p style="text-align:center"><a href="./PHP/connexion.php"> <=Retour à la connexion </a></p>';
exit;
//Formater la requete SQL
echo " L'adresse email saisi est inorrect";
?>